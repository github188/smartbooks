<%@ Page Language="C#" MasterPageFile="~/master.Master" AutoEventWireup="true" CodeBehind="jiaoxuedagang.aspx.cs" Inherits="SmartTeaching.jiaoxuedagang" Title="教学大纲" %>
        ...
        <div id="about">
            <div class="All_news">
                <ul>
                    ...
                    <li style="background-image: none; margin-top:25px;">
                        <div align="center">
