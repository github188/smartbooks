<%@ Page Language="C#" MasterPageFile="~/master.Master" AutoEventWireup="true" CodeBehind="jiaoxuemiaoshu.aspx.cs"
    Inherits="SmartTeaching.jiaoxuemiaoshu" Title="教学描述" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="left" style="width: 750px; height: auto; float: left;">
        ...
        <div id="about">
            <div class="All_news">
                <ul>
                    <asp:Repeater ID="Repjiaoxuemiaoshu" runat="server">
                        <ItemTemplate>
                            <li><span class="left"><a href='newsDetail.aspx?id=<%#Eval("NewsId")%>'>
                                ...
                                <span class="right"><%#Eval("CreateDate")%></span></li>
                        </ItemTemplate>
                    </asp:Repeater>
