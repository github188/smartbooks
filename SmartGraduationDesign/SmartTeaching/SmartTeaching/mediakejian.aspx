<%@ Page Language="C#" MasterPageFile="~/master.Master" AutoEventWireup="true" CodeBehind="mediakejian.aspx.cs"
    Inherits="SmartTeaching.mediakejian" Title="多媒体课件" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="about">
        <div class="All_about">
            <ul>
                <asp:DataList ID="kejian" runat="server" Width="99%">
                    <ItemTemplate>
                        <li>
