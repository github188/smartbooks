<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="NegativeReported.ascx.cs" Inherits="SmartPoms.Poms.Ascx.NegativeReported" %>

<asp:Panel ID="Panel1" runat="server" GroupingText="负面报道文章" Width="95%">
