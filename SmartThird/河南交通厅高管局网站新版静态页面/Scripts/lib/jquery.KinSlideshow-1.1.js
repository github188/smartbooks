...
$.fn.KinSlideshow = function(settings){
	  ...
	  settings = jQuery.extend({
		   ...
		   titleFont:{TitleFont_size:14,TitleFont_color:"#FFFFFF",TitleFont_family:"Verdana",TitleFont_weight:"bold"},//标题文字样式，(isHasTitleFont = true 前提下启用)
		   isHasBtn:true, //是否显示按钮
		   btn:{btn_bgColor:"#666666",btn_bgHoverColor:"#39587c",btn_fontColor:"#CCCCCC",btn_fontHoverColor:"#FFFFFF",btn_fontFamily:"Verdana",btn_borderColor:"#999999",btn_borderHoverColor:"#39587c",btn_borderWidth:1,btn_bgAlpha:0.7} //按钮样式设置，(isHasBtn = true 前提下启用)
	  },settings);
	  var titleBar_Bak = {titleBar_height:20,titleBar_bgColor:"#000000",titleBar_alpha:0.5}
	  var titleFont_Bak = {TitleFont_size:11,TitleFont_color:"#FFFFFF",TitleFont_family:"Verdana",TitleFont_weight:"bold"}
	  var btn_Bak = {btn_bgColor:"#FFFFFF",btn_bgHoverColor:"#39587c",btn_fontColor:"#CCCCCC",btn_fontHoverColor:"#FFFFFF",btn_fontFamily:"Verdana",btn_borderColor:"#39587c",btn_borderHoverColor:"#39587c",btn_borderWidth:1,btn_bgAlpha:0.7} //按钮样式设置，(isHasBtn = true 前提下启用)
	 ...
	 function KinSlideshow_setTitleBar(){
		...
		if(isNaN(getTitleBar_Height)){
			getTitleBar_Height = 20;
		}else if(getTitleBar_Height < 15){
			getTitleBar_Height = 15;
		};
