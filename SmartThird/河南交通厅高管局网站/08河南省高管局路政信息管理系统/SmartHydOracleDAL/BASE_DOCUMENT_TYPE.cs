...
namespace SmartHyd.OracleDAL {
    ...
    /// 档案类别表 -- 接口实现
    /// </summary>
    public partial class BASE_DOCUMENT_TYPE : IBASE_DOCUMENT_TYPE {
        /// <summary>
        /// 确定记录是否存在
        /// </summary>
        public bool Exists(decimal ID) {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(1) from BASE_DOCUMENT_TYPE");
            strSql.Append(" where ");
            strSql.Append(" ID = :ID  ");
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(Entity.BASE_DOCUMENT_TYPE model) {
            StringBuilder strSql = new StringBuilder();
        ...
        public bool Delete(decimal ID) {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from BASE_DOCUMENT_TYPE ");
            strSql.Append(" where ID=:ID ");
            OracleParameter[] parameters = {
					new OracleParameter(":ID", OracleType.Number,4)			};
            parameters[0].Value = ID;
        ...
        public Entity.BASE_DOCUMENT_TYPE GetEntity(decimal ID) {
            ...
            Entity.BASE_DOCUMENT_TYPE entity = new Entity.BASE_DOCUMENT_TYPE();
