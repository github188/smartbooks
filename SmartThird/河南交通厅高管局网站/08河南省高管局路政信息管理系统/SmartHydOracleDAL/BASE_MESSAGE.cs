...
namespace SmartHyd.OracleDAL {
    ...
    public partial class BASE_MESSAGE : IBASE_MESSAGE {
        ...
        public DataTable GetMyMessage(int uid) {
            string sec = string.Format("SELECT   b.userid, b.username, b.realname, b.phone,a.MESSAGEID ,a.messagebody, a.senddate FROM base_message a, base_user b WHERE a.sender = b.userid and a.touser = {0} ORDER BY a.senddate DESC", uid);
