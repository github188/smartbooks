...
namespace SmartHyd.OracleDAL {
    ...
    /// 路产设备类型表 -- 接口实现
    /// </summary>
    public partial class BASE_ROAD_TERM_TYPE : IBASE_ROAD_TERM_TYPE {
        /// <summary>
        /// 确定记录是否存在
        /// </summary>
        public bool Exists(decimal TYPEID) {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(1) from BASE_ROAD_TERM_TYPE");
            strSql.Append(" where ");
        ...
        /// 增加一条数据
        /// </summary>
        public void Add(Entity.BASE_ROAD_TERM_TYPE entity) {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into BASE_ROAD_TERM_TYPE(");
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(Entity.BASE_ROAD_TERM_TYPE entity) {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update BASE_ROAD_TERM_TYPE set ");
        ...
        public bool Delete(decimal TYPEID) {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from BASE_ROAD_TERM_TYPE ");
            strSql.Append(" where TYPEID=:TYPEID ");
            OracleParameter[] parameters = {
					new OracleParameter(":TYPEID", OracleType.Number,4)			};
            parameters[0].Value = TYPEID;
        ...
        /// 得到一个对象实体
        /// </summary>
        public Entity.BASE_ROAD_TERM_TYPE GetEntity(decimal TYPEID) {

            StringBuilder strSql = new StringBuilder();
            strSql.Append("select TYPEID, TYPENAME  ");
            strSql.Append("  from BASE_ROAD_TERM_TYPE ");
            strSql.Append(" where TYPEID=:TYPEID ");
            OracleParameter[] parameters = {
					new OracleParameter(":TYPEID", OracleType.Number,4)			};
            parameters[0].Value = TYPEID;
            ...
            Entity.BASE_ROAD_TERM_TYPE entity = new Entity.BASE_ROAD_TERM_TYPE();
