            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="height:100%">
                <tr>
                    <td style="height:24px;">
                        <div id="menu">
                            <div class="OperateNote"><span id="buttons"><img src="../Images/branch.png" border="0" />当前位置：路政巡逻管理中心》人工巡逻日志管理</span></div>
                            <ul>
                                <li id="menu_Title0" onclick="nTabs('menu',this,1)" class="normal"><a href="PatrolEdit.aspx" title="信息新增" target="PatrolFrame"><span id="buttons"><img src="../Images/add.png" border="0"/>&nbsp;新增日志</span></a></li>
                            </ul>
                        </div>
                    </td>
                </tr>
                <tr id="search_condition_panel" style="height:48px;border-bottom:1px solid #8cb2e2;">
                    <td >
                        <table id="PatrolSearch" width="480" border="0" cellspacing="0" cellpadding="0">
                          <tr >
                            <td width="80" height="24" align="right"><span id="PatrolSearch">单位：</span></td>
                            <td width="120" height="24">
                                <asp:DropDownList ID="ddl_unit" runat="server" Width="120">
                                </asp:DropDownList>
                            </td>
                            <td width="80" height="24" align="right"><span id="PatrolSearch">车牌号：</span></td>
                            <td width="120" height="24">
