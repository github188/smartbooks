<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="SmartHyd.ManageCenter.RoadLicense.List" %>
            ...
            <td style="height: 24px;">
                <div id="menu">
                    <div class="OperateNote">
                        <span id="buttons">
                            <img src="../../Images/branch.png" border="0" />当前位置：行政许可 > 涉路工程 </span>
                    </div>
                    <ul>
                        <li id="menu_Title0" onclick="nTabs('menu',this,1)" class="normal"><a href="Add.aspx"
                            target="RoadProjectFrame"><span id="Span1">
                                <img src="../../Images/add.png" alt="" border="0" />新建许可</span></a></li>
                    </ul>
                </div>
            </td>
        </tr>
