<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="SmartHyd.ManageCenter.Case.List" %>
            ...
            <td style="height: 24px;">
                <div id="menu">
                    <div class="OperateNote">
                        <span id="buttons">
                            <img src="../../Images/branch.png" border="0" />当前位置：路产管理 > 路产案件 </span>
                    </div>
                    <ul>
                        <li id="menu_Title0" onclick="nTabs('menu',this,1)" class="normal"><a href="Add.aspx"
                            target="RoadCaseFrame"><span id="Span1">
                                <img src="../../Images/add.png" alt="" border="0" />新建案件</span></a></li>
                    </ul>
                </div>
            </td>
        </tr>
