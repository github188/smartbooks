<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="SmartHyd.ManageCenter.DocumentType.List" %>
            ...
            <td style="height: 24px;">
                <div id="menu">
                    <div class="OperateNote">
                        <span id="buttons">
                            <img src="../../Images/branch.png" border="0" />当前位置：档案管理 > 档案分类 > 查看分类 </span>
                    </div>
                    <ul>
                                <li id="menu_Title0" onclick="nTabs('menu',this,1)" class="normal"><a href="Add.aspx"  target="RoadPropertyFrame"><span id="Span1">
                                        <img src="../../Images/add.png" alt="" border="0" />新建分类</span></a></li>
                            </ul>
                </div>
            </td>
        </tr>
            ...
            <tr>
                <td nowrap="nowrap" class="TableData">
                   <asp:GridView ID="grvAcceptList" runat="server" AutoGenerateColumns="False" BackColor="White"
                        ...
                        <Columns>
                            <asp:BoundField DataField="title" HeaderText="分类名称"></asp:BoundField>
                            <asp:BoundField DataField="sendcode" HeaderText="分类描述">
                                <ItemStyle Width="140" />
                            </asp:BoundField>
