 ...
 <table width="100%" class="TableBlock">
        <tr class="TableHeader">
            ...
            <td width="88%">
                ...
                <a href="../ManageCenter/Plan.aspx"><font size="+1">事务提醒&gt;&gt;</font></a>
            </td>
        </tr>
    </table>
    <ul id="menu">
        <li><a href="#tabs-1">添加事务提醒</a></li>
        <li><a href="#tabs-2">事务提醒管理</a></li>
    </ul>
    <!--添加事务提醒开始-->
    <div id="tabs-1">
                ...
                <tr>
                    ...
                    <td class="TableData">
                        <asp:TextBox ID="txtContent" runat="server" TextMode="MultiLine" 
                            CssClass="input {required:true}" Height="40px" Width="341px"></asp:TextBox>
                        <div class="validate ui-state-highlight ui-corner-all" style="border: none;">
                        </div>
                    </td>
                </tr>
