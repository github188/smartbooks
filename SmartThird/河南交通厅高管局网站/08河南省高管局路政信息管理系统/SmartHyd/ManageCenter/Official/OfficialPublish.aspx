                                    ...
                                    <table id="PatrolSearch" width="480px" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td height="24">
                                                ...
                                                <asp:Button ID="btnSearch" runat="server" CssClass="btn_search" 
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="操作选项">
                                                <ItemTemplate>
                                                    ...
                                                    <asp:LinkButton runat="server" CommandName="checkout" 
                                                        CommandArgument='<%#Eval("id") %>'>考核</asp:LinkButton>
                                                    <asp:LinkButton runat="server" CommandName="detail" 
                                                        CommandArgument='<%#Eval("id") %>'>详情</asp:LinkButton>
                                                    <asp:LinkButton runat="server" CommandName="isread" 
                                                        CommandArgument='<%#Eval("id") %>'>追踪</asp:LinkButton>
                                                </ItemTemplate>
                                                <ItemStyle Width="150" />
                                            </asp:TemplateField>
                                        </Columns>
