<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="View.aspx.cs" Inherits="SmartHyd.ManageCenter.RoadTerm.View" %>
            ...
            <td style="height: 24px;">
                <div id="menu">
                    <div class="OperateNote">
                        <span id="buttons">
                            <img src="../../Images/branch.png" border="0" />当前位置：路产管理 > 查看路产 </span>
                    </div>
    ...
    <table class="TableBlock" width="100%" align="center" cellpadding="0" cellspacing="0">
        <tbody>
            ...
            <tr>
                ...
                <td class="TableData" style="width: 100%;">
                    <asp:Label  runat="server" Text="登记时间"></asp:Label>
                    <asp:TextBox ID="txtBeginTime" runat="server"></asp:TextBox>
                    <asp:Label  runat="server" Text="竣工时间"></asp:Label>
            ...
            <tr class="TableControl" align="center">
                <td colspan="2" nowrap="nowrap">
                    ...
                    <asp:Button ID="btnCancel" runat="server" Text="返回" CssClass="Button" OnClick="btnCancel_Click" />
                </td>
            </tr>
        </tbody>
    </table>
