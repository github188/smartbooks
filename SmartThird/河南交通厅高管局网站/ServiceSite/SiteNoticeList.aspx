<%@ Page Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="SiteNoticeList.aspx.cs" Inherits="SiteNoticeList" Title="Untitled Page" %>
...
<div id="main" style="margin-top:10px;">
	<div class="right">
    	<dl id="pager">
        	<dt><p class="weizhi">您的位置：<a href="index.aspx">首页</a> >> <%=ViewState["typeName"]%></p><%=ViewState["typeName"]%></dt>
            <dd>
            <div class="page_bg">
            	<ul class="gonggaolist">
                    <asp:Repeater ID="rptSiteNoticeList" runat="server">
                     <ItemTemplate>
