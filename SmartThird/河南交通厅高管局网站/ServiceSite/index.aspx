<%@ Page Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="index.aspx.cs" Inherits="index" Title="Untitled Page" %>
...
<div class="left">
      ...
      <div class="diaocha">
          <div class="diaocha_con">
            <p class="right"><a href="ServiceVote.aspx" target="_blank">参与投票</a></p>
        <a href="SurveyResult.aspx" target="_blank">投票结果</a></div>
      </div>
</div>
        <div class="left mar_l10">
       	  <dl id="news">
           	<dt><p class="more37"><a href="ServiceNewsList.aspx" target="_blank">更多 >></a></p>驿站新闻</dt><dd><div class="news_con">     	
                        <ul class="newlist right">
                            <asp:Repeater ID="rptYzNews" runat="server">
                            <ItemTemplate>
                              <li><span>[<%# PubClass.Tool.Get_MonthAndDay(Eval("N_Time").ToString()) %>]</span><a href='NewsDetailInfo.aspx?nid=<%# Eval("N_ID") %>' target="_blank" title='<%# Eval("N_Title") %>'><%# PubClass.Tool.SubString(Eval("N_Title").ToString(),19) %></a></li>
                            </ItemTemplate>
                            </asp:Repeater>  
                        </ul>
                ...
                <ul id="GlideList2" class="GsPicList" style="left:0;">                    
                        ...
                        <ItemTemplate>
                        <li>
                         <a href='newsImages/<%# CommonFunction._GetMidInfo(Eval("N_Title").ToString(),"{","}") %>' rel="lightbox[picnews]" title='<%# CommonFunction._GetMidInfo(Eval("N_Title").ToString(),"(",")") %>'><img src='newsImages/<%# CommonFunction._GetMidInfo(Eval("N_Title").ToString(),"[","]") %>' alt='<%# CommonFunction._GetMidInfo(Eval("N_Title").ToString(),"(",")") %>' /></a>
                  	<div class="title"><a href='NewsDetailInfo.aspx?nid=<%# Eval("N_ID") %>' target="_blank" title='<%# CommonFunction._GetMidInfo(Eval("N_Title").ToString(), "(", ")") %>'><%# PubClass.Tool.SubString(CommonFunction._GetMidInfo(Eval("N_Title").ToString(), "(", ")"), 10)%></a></div>
                       </li>
                        </ItemTemplate>
                        </asp:Repeater>
          ...
          <script type="text/javascript">
            ...
            <dl id="zhengshu" class="mar_t10">
            	<dt><p class="more32"><a href="CertificateList.aspx" target="_blank">更多 >></a></p></dt>
                <dd>
                	<ul class="zhengshu">
                        <asp:Repeater ID="rptISO" runat="server">
                        <ItemTemplate>
                          <li><a href='CertificateImg/<%# CommonFunction._GetMidInfo(Eval("N_Title").ToString(),"{","}") %>' rel="lightbox[iso]" title='<%# Eval("N_Content") %>'><p><img src="CertificateImg/<%# CommonFunction._GetMidInfo(Eval("N_Title").ToString(),"[","]") %>" width="128" alt='<%# Eval("N_Content") %>' /></p></a><a href='CertificateImg/<%# CommonFunction._GetMidInfo(Eval("N_Title").ToString(),"{","}") %>' rel="lightbox[isot]" title='<%# Eval("N_Content") %>'><%# PubClass.Tool.SubString(Eval("N_Content").ToString(),19)%></a></li>
                        </ItemTemplate>
                        </asp:Repeater>
                    </ul>
                    <div class="clear"></div>
                </dd>
                <dd class="zhengshu_b"></dd>
            </dl>
        </div>
      <div class="left mar_l10">
      	<dl id="gonggao">
            	<dt><p class="more37"><a href="SiteNoticeList.aspx?tid=2" target="_blank">更多 >></a></p>站内公告</dt><dd><div class="gonggao_con">   
                    <marquee direction="up" scrollamount="3"  height="132px" width="230px">  	
                        <ul class="gglist">
                         <asp:Repeater ID="rptSiteNotice" runat="server">
                         <ItemTemplate>
                             <li><%# Eval("N_Content") %><span>[<%# PubClass.Tool.Get_ShortDate(Eval("N_Time").ToString())%>]</span></li>
                         </ItemTemplate>
                         </asp:Repeater>     
                        </ul>
                        </marquee>
                ...
                <dd class="gonggao_b"></dd>
            </dl>
            <dl id="guanli" class="mar_t10">
            	<dt><p class="more37"><a href="NewsList.aspx?tid=3"  target="_blank">更多 >></a></p>管理制度</dt><dd><div class="guanli_con">     	
                        <ul class="gllist">
                            <asp:Repeater ID="rptGLZD" runat="server">
                            <ItemTemplate>
                               <li><span>[<%# PubClass.Tool.Get_MonthAndDay(Eval("N_Time").ToString())%>]</span><a href='NewsDetailInfo.aspx?nid=<%# Eval("N_ID") %>' target="_blank" title='<%# Eval("N_Title") %>'><%# PubClass.Tool.SubString(Eval("N_Title").ToString(),14) %></a></li>
                            </ItemTemplate>
                            </asp:Repeater> 
                        </ul>
                    </div>        
                </dd>
                <dd class="guanli_b"></dd>
            </dl>
      </div>
      <div class="clear"></div>
  </div>
    <!--第二层-->
	<div class="mar_t10">
    <div class="serivcelist_t"><p class="right mar_t20 mar_r20"><span style="color:#039">服务内容：餐厅服务、超市服务、加油服务、客房服务、汽修服务、停车服务</span></p></div>
    <div class="servicelist_bg left type" >
    	<table width="320" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <th width="63" align="center">餐厅<br />
            服务</th>
            <td width="257">
             <div class="typestyle">
                 <a href='javascript:ShowItemDiv("item1",7,1)' >经营品种</a>
                 <a href='javascript:ShowItemDiv("item1",7,2)'  >收费标准</a>
                 <a href='javascript:ShowItemDiv("item1",7,3)'  >提供餐别</a>
                 <a href='javascript:ShowItemDiv("item1",7,4)' style="border-right:none;"  >服务承诺</a>
                 <a href='javascript:ShowItemDiv("item1",7,5)'  >自助餐标准</a>
                 <a href='javascript:ShowItemDiv("item1",7,6)' >会议培训用餐</a>
                 <a href='javascript:ShowItemDiv("item1",7,7)' >特色菜品</a>
               </div></td>
          </tr>
        </table>
        <div id="item1div1" style="display:block">
           <ul class="typelist">
               ...
               <ItemTemplate>
               <li><span>[<%# PubClass.Tool.Get_MonthAndDay(Eval("I_Time").ToString()) %>]</span><a href='ServiceItemDetail.aspx?itemid=<%# Eval("I_ID") %>' target="_blank" title='<%# Eval("I_Title") %>'> <%# PubClass.Tool.SubString(Eval("I_Title").ToString(),19) %></a></li>
               </ItemTemplate>
               </asp:Repeater>
        </ul>
        </div>
...
<div class="servicelist_bg left mar_l10 type" >
    	<table width="320" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <th width="63" align="center" valign="middle">超市<br />
            服务</th>
            <td width="257" valign="top"><div class="typestyle">
            <a href='javascript:ShowItemDiv("item2",4,1)'  >经营品种</a>
            <a href='javascript:ShowItemDiv("item2",4,2)'   >特产专柜</a>
            <a href='javascript:ShowItemDiv("item2",4,3)'  >急救药品</a>
            <a href='javascript:ShowItemDiv("item2",4,4)' style="border-right:none;"   >工艺品</a></div></td>
          </tr>    
      </table>
    ...
    <div class="servicelist_bg left mar_l10 type" >
    	<table width="320" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <th width="63" align="center">客房<br />
            服务</th>
            <td width="257" valign="top"><div class="typestyle">
            <a href='javascript:ShowItemDiv("item3",3,1)'  >供房类型</a>
            <a href='javascript:ShowItemDiv("item3",3,2)'  >收费标准</a>
            <a href='javascript:ShowItemDiv("item3",3,3)'  >供房数量</a></div></td>
          </tr>
        </table>
    ...
    <div class="servicelist_bg left type" >
    	<table width="320" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <th width="63" align="center">加油<br />
            服务</th>
            <td width="257" valign="top"><div class="typestyle">
            <a href='javascript:ShowItemDiv("item4",3,1)'  >供应油品</a>
            <a href='javascript:ShowItemDiv("item4",3,2)' >油品价格</a>
            <a href='javascript:ShowItemDiv("item4",3,3)' >加油机数量</a></div></td>
          </tr>   
        </table>
...
<div class="servicelist_bg left mar_l10 type" >
    	<table width="320" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <th width="63" align="center" valign="middle">汽修<br />
            服务</th>
            <td width="257" valign="top"><div class="typestyle">
            <a href='javascript:ShowItemDiv("item5",3,1)' >维修范围</a>
            <a href='javascript:ShowItemDiv("item5",3,2)'  >收费标准</a>
            <a href='javascript:ShowItemDiv("item5",3,3)'  >资质类别</a></div></td>
          </tr>      
</table>
...
<div class="servicelist_bg left mar_l10 type" >
    	<table width="320" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <th width="63" align="center">停车<br />
            服务</th>
            <td width="257" valign="top"><div class="typestyle">
            <a href='javascript:ShowItemDiv("item6",4,1)'  >停车分区</a>
            <a href='javascript:ShowItemDiv("item6",4,2)' >停车位数量</a>
            <a href='javascript:ShowItemDiv("item6",4,3)'  style="border-right:none; width:100px;" >危险品专属车位</a>
            <a href='javascript:ShowItemDiv("item6",4,4)'  >降温加水服务</a></div></td>
          </tr>     
  </table>
	...
	<div id="link">
    	<dl>
        	<dt>友情链接</dt><dd><asp:Repeater ID="rptMyLink" runat="server">
                <ItemTemplate>
                   <a href='<%# Eval("L_URL") %>' title='<%# Eval("L_Title") %>' target="_blank"><%# Eval("L_Title")%></a>
                </ItemTemplate>
                </asp:Repeater>
            </dd>
        </dl>
