<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PolicyRuleInfo.aspx.cs" Inherits="PolicyRuleInfo" %>
...
<head runat="server">
    ...
    <title><%=((DataTable)ViewState["dtNews"]).Rows[0]["N_Title"] + "-" + ((DataTable)ViewState["dtNews"]).Rows[0]["T_Name"] %>-河南省交通运输厅高速公路管理局门户网站</title>
...
<body>
  ...
  <div class="right wid580">
    <div class="weizhi">您的位置：<a href="index.aspx">首页</a> >>
     <a href='PolicyRulesList.aspx?tid=50'><%=((DataTable)ViewState["dtNews"]).Rows[0]["T_Remark"] %></a> >>
      <a href='PolicyRulesList.aspx?tid=<%=((DataTable)ViewState["dtNews"]).Rows[0]["T_ID"] %>'><%=((DataTable)ViewState["dtNews"]).Rows[0]["T_Name"] %></a></div>
    	<div class="pages">
