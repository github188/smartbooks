<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PageInfoDetail.aspx.cs" Inherits="PageInfoDetail" %>
...
<body>
  ...
  <div class="right wid580">
    <div class="weizhi">您的位置：<a href="index.aspx">首页</a> >> <a href="GsNewsList.aspx?tid=<%=((DataTable)ViewState["dtNews"]).Rows[0]["T_ID"]%>"><%=((DataTable)ViewState["dtNews"]).Rows[0]["T_Name"]%></a></div>
    	<div class="pages">
