<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NewsList.aspx.cs" Inherits="road_NewsList" %>
    ...
    <form id="form1" runat="server">
        ...
        <div id="main2">
          <div class="right wid580">
            <div class="weizhi">您的位置：<a href="../index.aspx">首页</a> >> <a href="Road_Index.aspx"><%=ViewState["Remark"] %></a> >> <a href="NewsList.aspx?tid=<%=ViewState["tid"] %>"><%=ViewState["TName"] %></a></div>
   	        <div class="pages">
        	        <ul class="newlist">
        	            <asp:Repeater ID="Repeater_dwgl" runat="server">
                             <ItemTemplate>
                                <li><span>[<%#PubClass.Tool.Get_ShortDate(Eval("N_Time").ToString()) %>]</span><a href="Page.aspx?id=<%#Eval("N_ID") %>" title="<%#Eval("N_Title") %>"><%#PubClass.Tool.SubString(Eval("N_Title").ToString(),40)%></a></li>
                             </ItemTemplate>
                        </asp:Repeater>
                    </ul>
                    <div class="fanye">
