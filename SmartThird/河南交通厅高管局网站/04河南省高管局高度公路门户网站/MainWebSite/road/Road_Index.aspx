                     ...
                     <dd>
                       <ul>
                         <asp:Repeater ID="Repeater_gzdt" runat="server">
                             <ItemTemplate>
                                <li><span>[<%# PubClass.Tool.Get_ShortDate(Eval("N_Time").ToString())%>]</span><a href="Page.aspx?id=<%#Eval("N_ID") %>" title="<%#Eval("N_Title") %>"><%# PubClass.Tool.SubString(Eval("N_Title").ToString(), 25)%></a></li>                             
                             </ItemTemplate>
                         </asp:Repeater>
                       </ul>
                       <div class="new_img">
                               ...
                               <td valign="top" id="marquePic1"><table cellpadding="0" cellspacing="0" border="0" class="gundong2">
                                 <tr id="s">
                                    <asp:Repeater ID="Repeater_dwjs" runat="server">
                                         <ItemTemplate>
                                            <td>
                                               <p> <a href="../newsimages/<%#Eval("N_ImgPath") %>" title="<%#Eval("N_Title") %>">
                                                    <img src='../newsimages/<%#Eval("N_ImgView") %>' alt="<%#Eval("N_Title") %>" width="120" height="90" />
                                                </a></p>
                                                <span>&nbsp;</span>
                                                <!--
                                                <%#PubClass.Tool.SubString(Eval("N_Title").ToString(),12) %>-->
                                            </td>    
                                         </ItemTemplate>
                                     </asp:Repeater>
                                 </tr>
                                 ...
                                 <asp:Repeater ID="Repeater_gg" runat="server">
                                     <ItemTemplate>
                                        <li>
                                            ...
                                            <span>[<%#Tool.Get_ShortDate(Eval("N_Time").ToString()) %>]</span></li>                           
                                     </ItemTemplate>
                                 </asp:Repeater>
                            </ul>
                         </marquee>
                     ...
                     <dd>
                       <ul>
                         <asp:Repeater ID="rptRoadCondition" runat="server">
                             <ItemTemplate>
                                <li><span>[<%#PubClass.Tool.Get_MonthAndDay(Eval("N_Time").ToString()) %>]</span><a href="../RoadConditionDetail.aspx?nid=<%#Eval("N_ID") %>" title="<%#Eval("N_Title") %>" target="_blank"><%#PubClass.Tool.SubString(Eval("N_Title").ToString(),15)%></a></li>
                             </ItemTemplate>
                         </asp:Repeater>
                        </ul>
                     </dd>
            ...
            <div class="main">
                  ...
                  <dd>
                    <ul>
                      <asp:Repeater ID="Repeater_dwgl" runat="server">
                         <ItemTemplate>
                            <li><span>[<%#PubClass.Tool.Get_ShortDate(Eval("N_Time").ToString()) %>]</span><a href="Page.aspx?id=<%#Eval("N_ID") %>" title="<%#Eval("N_Title") %>"><%#Tool.SubString(Eval("N_Title").ToString(),18)%></a></li>
                         </ItemTemplate>
                      </asp:Repeater>
                    </ul>
                  </dd>
              ...
              <div class="wid270">
                  ...
                  <div id="lzfc">
                    <ul>                      
                      <asp:Repeater ID="Repeater_lzfc" runat="server">
                         <ItemTemplate>
                            <li>
                                <a href="../newsimages/<%#Eval("N_ImgPath") %>" title="<%#Eval("N_Title") %>">
                                    <img src='../newsimages/<%#Eval("N_ImgView") %>' alt= "<%#Eval("N_Title") %>" width="110" height="80" />
                                </a>
                ...
                <div class="contact mar_t10">
                  <p class="contact_con">地址：郑州市郑东新区农业东路100号(金水<br />
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;东路与农业东路交叉口东北角)<br />
                    邮编：450016<br />
                    电话：0371-87166914<br />
                    邮箱：gslz@hncd.gov.cn</p>
                </div>
              </div>
              <div class="clear"></div>
            </div>
