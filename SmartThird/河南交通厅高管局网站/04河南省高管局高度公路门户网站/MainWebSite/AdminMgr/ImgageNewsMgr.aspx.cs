...
public partial class AdminMgr_ImgageNewsMgr : System.Web.UI.Page
{
    ...
    {
        Response.Redirect("AddImageNews.aspx?action=add&tid=" + Convert.ToInt32(((DataTable)ViewState["dtType"]).Rows[0]["T_ID"]));
    }
