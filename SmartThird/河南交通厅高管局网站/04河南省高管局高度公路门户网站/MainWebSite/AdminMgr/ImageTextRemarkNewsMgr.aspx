<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ImageTextRemarkNewsMgr.aspx.cs" Inherits="AdminMgr_ImageTextRemarkNewsMgr" %>
            ...
            <Columns>
                ...
                <asp:TemplateField>
                    ...
                    <ItemTemplate>
                        ...
                        <a href='AddImageTextRemarkNews.aspx?tid=<%#DataBinder.Eval(Container.DataItem,"T_ID") %>&nid=<%#DataBinder.Eval(Container.DataItem,"N_ID") %>&action=update'>编辑</a>&nbsp;
