...
public partial class AdminMgr_AddStationStar : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            if (Request.QueryString["nid"] != null)
            {
                ...
                txtRemarkContent.Text = dt.Rows[0]["N_HotIco"].ToString();
    ...
    protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
    {
        ...
        CommonFunction.AlertAndRedirect(Literal1, "操作成功", "StationStarMgr.aspx?tid=" + Convert.ToInt32(((DataTable)ViewState["dtType"]).Rows[0]["T_ID"]));
    }
}
