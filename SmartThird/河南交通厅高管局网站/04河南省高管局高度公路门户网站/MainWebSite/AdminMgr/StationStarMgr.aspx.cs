...
public partial class AdminMgr_StationStarMgr : System.Web.UI.Page
{
    ...
    {
        Response.Redirect("AddStationStar.aspx?action=add&tid=" + Convert.ToInt32(((DataTable)ViewState["dtType"]).Rows[0]["T_ID"]));
    }
