<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NewsPaperMgr.aspx.cs" Inherits="AdminMgr_NewsPaperMgr" %>
<%@ Register Assembly="AspNetPager" Namespace="Wuqi.Webdiyer" TagPrefix="webdiyer" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>服务区行业报刊-河南省交通运输厅高速公路管理局</title>
...
<body>
    ...
    <div  id="mgrmenu">
    <div class="top">服务区管理 >> 服务区行业报刊</div>
    <div class="buttom"><span><asp:ImageButton ID="ImageButton2" runat="server" ImageUrl="~/AdminMgr/images/btnAdd.jpg" OnClick="ImageButton1_Click" /></span></div>
    </div>
    
    <div>
        <asp:GridView ID="GridView1" runat="server" Width="100%" HeaderStyle-BackColor="#6298e1" HeaderStyle-Height="25" RowStyle-BackColor="#ebf2f9" HeaderStyle-Font-Bold="true" HeaderStyle-Font-Size="13" RowStyle-Height="20" RowStyle-HorizontalAlign="Center" BorderColor="#6298E1" AutoGenerateColumns="False" OnRowCommand="GridView2_RowCommand">
            ...
            <Columns>
                <asp:BoundField DataField="N_Title" HeaderText="报刊标题" ItemStyle-HorizontalAlign="center" >
                ...
                <asp:TemplateField>
                    ...
                    <ItemTemplate>
                        <a href='AddNewsPaper.aspx?nid=<%#DataBinder.Eval(Container.DataItem,"N_ID") %>&action=update'>编辑</a>&nbsp;
