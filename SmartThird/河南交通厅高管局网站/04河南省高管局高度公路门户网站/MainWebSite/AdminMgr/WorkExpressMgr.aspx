<%@ Page Language="C#" AutoEventWireup="true" CodeFile="WorkExpressMgr.aspx.cs" Inherits="AdminMgr_WorkExpressMgr" %>
        ...
        <asp:GridView ID="GridView1" runat="server" Width="100%" HeaderStyle-BackColor="#6298e1" HeaderStyle-Height="25" RowStyle-BackColor="#ebf2f9" HeaderStyle-Font-Bold="true" HeaderStyle-Font-Size="13" RowStyle-Height="20" RowStyle-HorizontalAlign="Center" BorderColor="#6298E1" AutoGenerateColumns="False" OnRowCommand="GridView1_RowCommand">
            ...
            <Columns>
                ...
                <asp:TemplateField>
                    ...
                    <ItemTemplate>
                     <a href='../workexpress/<%#DataBinder.Eval(Container.DataItem,"N_ImgPath") %>' target="_blank">预览</a>&nbsp;
                        <a href='AddWorkExpress.aspx?tid=<%#DataBinder.Eval(Container.DataItem,"T_ID") %>&nid=<%#DataBinder.Eval(Container.DataItem,"N_ID") %>&action=update'>编辑</a>&nbsp;
