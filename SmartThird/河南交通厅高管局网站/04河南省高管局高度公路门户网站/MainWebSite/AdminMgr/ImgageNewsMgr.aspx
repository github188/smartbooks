<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ImgageNewsMgr.aspx.cs" Inherits="AdminMgr_ImgageNewsMgr" %>
            ...
            <Columns>
                ...
                <asp:TemplateField>
                    ...
                    <ItemTemplate>
                        ...
                        <a href='AddImageNews.aspx?tid=<%#DataBinder.Eval(Container.DataItem,"T_ID") %>&nid=<%#DataBinder.Eval(Container.DataItem,"N_ID") %>&action=update'>编辑</a>&nbsp;
