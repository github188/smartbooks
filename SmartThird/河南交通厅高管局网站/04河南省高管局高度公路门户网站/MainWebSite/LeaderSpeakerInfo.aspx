<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LeaderSpeakerInfo.aspx.cs" Inherits="LeaderSpeakerInfo" %>
...
<body>
  ...
  <div class="right wid580">
    <div class="weizhi">您的位置：<a href="index.aspx">首页</a> >> <a href="LeaderSpeakerList.aspx?tid=<%=((DataTable)ViewState["dtNews"]).Rows[0]["T_ID"]%>"><%=((DataTable)ViewState["dtNews"]).Rows[0]["T_Name"]%></a></div>
    	<div class="pages">
        		<h1><%=((DataTable)ViewState["dtNews"]).Rows[0]["N_Title"]%></h1>
                <p class="page_date"><%=((DataTable)ViewState["dtNews"]).Rows[0]["N_From"]%>  &nbsp;&nbsp;&nbsp; <%=PubClass.Tool.Get_ShortDate(((DataTable)ViewState["dtNews"]).Rows[0]["N_Time"].ToString())%> </p>
                <div class="page_con">
