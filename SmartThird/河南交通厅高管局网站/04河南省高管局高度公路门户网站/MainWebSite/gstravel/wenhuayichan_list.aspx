<%@ Page Language="C#" AutoEventWireup="true" CodeFile="wenhuayichan_list.aspx.cs" Inherits="gstravel_wenhuayichan_list" %>
...
<head id="Head1" runat="server">
    ...
    <title>文化遗产-历史概况-高速出游-河南省交通运输厅高速公路管理局门户网站</title>
...
<body>
 ...
 <div style=" width:800px; margin:0 auto;"><iframe src="../CommonTop.aspx" scrolling="no" frameborder="0" style=" margin:0 auto; width:800px; height:253px; overflow:hidden;"></iframe></div>
    ...
    <div id="main2">
  <div class="wid800tit mar_b10">您的位置：<a href="../index.aspx">首页</a> >> <a href="chuyou.html">高速出游</a> >> <a href="lishigaikuang_list.html">历史概况</a> >> 文化遗产</div>
  <div class="wid490 right">
    <ul class="gscy_list">
      <asp:Repeater ID="rptWHYC" runat="server">
              <ItemTemplate>
                <li><span>[<%# PubClass.Tool.Get_ShortDate(Eval("N_Time").ToString())%>]</span><a href='wenhuayichan_info.aspx?nid=<%#  Eval("N_ID") %>' target="_blank" title='<%# Eval("N_Title") %>'>&middot;<%# PubClass.Tool.SubString(Eval("N_Title").ToString(), 30)%> </a></li>
              </ItemTemplate>
            </asp:Repeater>  
    </ul>
