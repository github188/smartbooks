...
<head runat="server">
    ...
    <title><%=((DataTable)ViewState["dtType"]).Rows[0]["T_Name"]%>-河南省交通运输厅高速公路管理局门户网站</title>
...
<body>
  ...
  <div class="right wid580">
    <div class="weizhi">您的位置：<a href="index.aspx">首页</a> >> <a href="DepartBasicInfo.aspx?tid=60"><%=((DataTable)ViewState["dtType"]).Rows[0]["T_Remark"]%></a> >> <%=((DataTable)ViewState["dtType"]).Rows[0]["T_Name"]%></div>
    <ul class="piclist">
  ...
  <div class="wid210">
    ...
    <div class="dashiji mar_t10">
      <dl>
        ...
        <dd>
          <ul class="lanmulist">
            <li> <asp:LinkButton ID="LinkButton1" runat="server" OnCommand="LinkButton1_Command" CommandName="eventlist" CommandArgument="2011">2011年</asp:LinkButton></li>
            <li> <asp:LinkButton ID="LinkButton2" runat="server" OnCommand="LinkButton1_Command" CommandName="eventlist" CommandArgument="2010">2010年</asp:LinkButton></li>
            <li> <asp:LinkButton ID="LinkButton3" runat="server" OnCommand="LinkButton1_Command" CommandName="eventlist" CommandArgument="2009">2009年</asp:LinkButton></li>
            <li> <asp:LinkButton ID="LinkButton4" runat="server" OnCommand="LinkButton1_Command" CommandName="eventlist" CommandArgument="2008">2008年</asp:LinkButton></li>
            <li> <asp:LinkButton ID="LinkButton5" runat="server" OnCommand="LinkButton1_Command" CommandName="eventlist" CommandArgument="2007">2007年</asp:LinkButton></li>
            <li> <asp:LinkButton ID="LinkButton6" runat="server" OnCommand="LinkButton1_Command" CommandName="eventlist" CommandArgument="2006">2006年</asp:LinkButton></li>
            <li> <asp:LinkButton ID="LinkButton7" runat="server" OnCommand="LinkButton1_Command" CommandName="eventlist" CommandArgument="2005">2005年</asp:LinkButton></li>
          </ul>
        </dd>
        <dd class="lanmu_b"></dd>
      </dl>
