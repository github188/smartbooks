<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LeaderSpeakerList.aspx.cs" Inherits="LeaderSpeakerList" %>
...
<body>
  ...
  <div class="right wid580">
    	<div class="weizhi">您的位置：<a href="index.aspx">首页</a> >> <%=((DataTable)ViewState["dtType"]).Rows[0]["T_Name"]%></div>
        <ul class="alllist">
            <asp:Repeater ID="rptLeaderSpeakerList" runat="server">
              <ItemTemplate>
                <li><span>[<%# PubClass.Tool.Get_ShortDate(Eval("N_Time").ToString())%>]</span><a href='LeaderSpeakerInfo.aspx?nid=<%#  Eval("N_ID") %>' target="_blank" title='<%# Eval("N_Title") %>'><%# PubClass.Tool.SubString(Eval("N_Title").ToString(), 37)%> </a></li>
              </ItemTemplate>
            </asp:Repeater>  
        </ul>
        <div class="fanye">
  ...
  <div class="wid210">
    ...
    <div class="mar_t10"><a href="LetterOf Undertaking.aspx" target="_blank"><img src="images/chengnuo.jpg" width="230" height="60" /></a></div>
    <div class="mar_t10"><a href="report/login.aspx" title="述职述廉述学报告" target="_blank"><img src="images/shuzi_link.jpg" width="210" height="68" alt="述职述廉述学报告" /></a></div>
  </div>
</div>
