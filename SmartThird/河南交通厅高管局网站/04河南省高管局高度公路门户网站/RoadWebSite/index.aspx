...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="main">
        ...
        <dl id="jianjie" class=" left wid550">
            <dt>
                <p class="right mar_t10 mar_r20">
                    <a href="DepartBasicInfo.aspx">更多>></a></p>
            </dt>
            <dd>
                <div class="jianjie_r">
                    <div class="jianjie_l">
                        <div style="margin: 10px 15px;">
                            ...
                            <%=PubClass.Tool.SubString(depart.RD_Remark,255) %><a href="DepartBasicInfo.aspx"
                                class="f60">[点击详情]</a></div>
                    </div>
                </div>
            </dd>
        </dl>
    ...
    <div class="main">
        <dl id="fagui" class="left">
            <dt>
                <p class="right mar_t15 mar_r20">
                    <a href="NewsList.aspx?tid=2">更多>></a></p>
            </dt>
            <dd>
                <div class="new_r">
                    <div class="new_l">
        ...
        <dl id="dongtai" class="left mar_l10">
            <dt>
                <p class="right mar_t15 mar_r20">
                    <a href="NewsList.aspx?tid=1">更多>></a></p>
            </dt>
            <dd>
                <div class="new_r">
                    <div class="new_l">
    ...
    <div class="main">
        <dl id="fengcai">
            <dt>
                <p class="right mar_t10 mar_r20">
                    <a href="RongYuList.aspx?tid=3">更多>></a></p>
            </dt>
            <dd>
                <div class="fengcai_r">
                    <div class="fengcai_l">
