...
<head runat="server">
    ...
    <title>编辑路政单位LOGO-路政网站后台管理系统</title>
...
<body>
    ...
    <div id="box_mr2">
        ...
        <div id="nav_mgr">
           <div class="left"><img src="images/tb.gif" width="14" height="14" align="absmiddle" />路政单位信息管理&nbsp;&nbsp;>>&nbsp;&nbsp;编辑路政单位LOGO</div>
        </div>
  ...
  <tr>
    ...
    <td>
        <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="~/management/images/btn_save.gif" OnClientClick="return CheckSubmitForm()"  OnClick="ImageButton1_Click" /></td>
  </tr>
  </table>
  <div class="group_remark"><span>操作提示：</span>路政单位LOGO应为.jpg或.gif格式,宽高位800*153像素,该LOGO应由路政单位提供，美工处理后，方可上传。</div>
    </div>
