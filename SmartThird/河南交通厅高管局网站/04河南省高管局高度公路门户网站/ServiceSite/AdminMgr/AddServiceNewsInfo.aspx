<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddServiceNewsInfo.aspx.cs"
    Inherits="AdminMgr_AddServiceNewsInfo" ValidateRequest="false" %>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtForm"
                            ErrorMessage="请输入文章出处"></asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                    <td width="100" height="30" align="center">
