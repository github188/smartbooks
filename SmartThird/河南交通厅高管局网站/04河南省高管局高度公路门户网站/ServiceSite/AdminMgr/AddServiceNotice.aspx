<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddServiceNotice.aspx.cs"
    Inherits="AdminMgr_AddServiceNotice" %>
...
<body>
    ...
    <div class="divContent">
        <fieldset>
            ...
            <table width="550" border="0" align="center" cellpadding="3" cellspacing="0" style="border-collapse: collapse"
                bordercolor="#B8C9D6">
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtNotice" runat="server" CssClass="InputBorderStyle" Height="241px"
                ...
                <tr>
                    ...
                    <td style="height: 32px">
                        <asp:ImageButton ID="btnAdd" runat="server" ImageUrl="~/AdminMgr/images/btnSubmit.jpg"
                ...
                <tr>
                    <td height="30" align="left" colspan="2">
                        公告公示：以一句话的形式，展示服务区要公告公示的内容，性质与黑板报类似。
                    </td>
                </tr>
            </table>
        </fieldset>
