<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddServiceItemNews.aspx.cs" Inherits="AdminMgr_AddServiceItemNews" ValidateRequest="false" %>
...
<body>
  ...
  <tr>
    ...
    <td><textarea name="t_contents" style="display:none" class="InputBorderStyle"><%=ViewState["strContent"]%></textarea>
