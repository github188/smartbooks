<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddServiceItemNews.aspx.cs"
    Inherits="AdminMgr_AddServiceItemNews" ValidateRequest="false" %>
...
<body>
    ...
    <div class="divContent">
        <fieldset>
            ...
            <table width="800" border="0" align="center" cellpadding="3" cellspacing="0" bordercolor="#B8C9D6"
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtTitle" runat="server" CssClass="InputBorderStyle" Width="600px"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtTitle"
                            ErrorMessage="输入标题"></asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                    ...
                    <textarea name="t_contents"><%=ViewState["strContent"]%></textarea>
                        <%--<textarea name="t_contents" style="display: none" class="InputBorderStyle"><%=ViewState["strContent"]%></textarea>--%>
