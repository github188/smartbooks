<%@ Page Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="NewsList.aspx.cs" Inherits="NewsList" Title="Untitled Page" %>
...
<div id="main" style="margin-top:10px;">
	<div class="right">
    	<dl id="pager">
        	<dt><p class="weizhi">您的位置：<a href="#">首页</a> >> <a href="#"><%=ViewState["typeName"].ToString()%></a></p><%=ViewState["typeName"].ToString()%></dt>
            <dd>
                <div class="page_bg">
            	<ul class="page_newlist">
                    <asp:Repeater ID="rptNewsList" runat="server">
                    <ItemTemplate>
                       <li><span>[<%# PubClass.Tool.Get_MonthAndDay(Eval("N_Time").ToString()) %>]</span><a href='NewsDetailInfo.aspx?nid=<%# Eval("N_ID") %>' target="_blank" title='Eval("N_Title")'><%# PubClass.Tool.SubString(Eval("N_Title").ToString(),45)%></a></li>
                    </ItemTemplate>
                    </asp:Repeater>  
                </ul>
                <div class="pages">
