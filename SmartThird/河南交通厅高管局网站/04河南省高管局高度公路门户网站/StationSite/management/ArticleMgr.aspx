...
<head runat="server">
    <meta http-equiv="Content-Type" content="text/html; charset=gb2312" />
     <title><%=((DataTable)ViewState["dtType"]).Rows[0]["T_Name"]%>信息管理-河南省交通运输厅高速公路管理局收费管理网站后台管理系统</title>
...
<body>
    ...
    <div id="nav_mgr">
        <div class="left"><img src="images/tb.gif" width="14" height="14" align="absmiddle" /><%=((DataTable)ViewState["dtType"]).Rows[0]["T_Name"]%>信息管理</div>
        <div class="right"><img src="images/add.gif" width="10" height="10" align="absmiddle" /><a href="<%=((DataTable)ViewState["dtType"]).Rows[0]["AddURL"]%>">添加</a></div>
    </div>
                ...
                <asp:BoundField DataField="N_Date" HeaderText="发布日期" DataFormatString="{0:yyyy-MM-dd}" HtmlEncode="False" >
                  ...
                  <asp:TemplateField>
                   ...
                   <asp:TemplateField>
                         ...
                         <ItemTemplate>
                             <a href='<%#DataBinder.Eval(Container.DataItem,"EditURL") %>&nid=<%#DataBinder.Eval(Container.DataItem,"N_ID") %>'><img src="images/edit.gif" /></a>
                         </ItemTemplate>
                         <ItemStyle Width="60px" />
                    </asp:TemplateField>
