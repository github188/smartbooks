   ...
   public class CommonFunction
    {
       ...
       /// </summary>
       public static void isLoginCheck(string toTimeoutURL)
       {
           if (HttpContext.Current.Session["StationUser"] != null)
           {
               if (HttpContext.Current.Session["StationUser"].ToString().Length == 0)
               {
                   HttpContext.Current.Response.Redirect(toTimeoutURL);
