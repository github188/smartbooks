<%@ Page Language="C#" MasterPageFile="~/index.master" AutoEventWireup="true" CodeFile="StarsList.aspx.cs" Inherits="StarsList" Title="" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 ...
 <!--main begin-->
	<div id="mainbody">
    	<!--最新动态-->
    	<dl id="starlist" class="right">
        	<dt><p><a href="index.aspx">首页</a> >> 
                <asp:Label ID="lblTypeName" runat="server" Text="type"></asp:Label></p></dt>
            <dd>
            	<ul>
                	<asp:Repeater ID="rptNewsList" runat="server">
                     <ItemTemplate>
                        <li><span>[<%# PubClass.Tool.Get_ShortDate(Eval("N_Date").ToString()) %>]</span><a href='StarInfo.aspx?nid=<%# Eval("N_ID") %>' title='<%# Eval("N_Title") %>'><%# PubClass.Tool.SubString("[" + Eval("N_From").ToString() + "]" + Eval("N_Title").ToString(), 34)%></a></li>
                     </ItemTemplate>
                    </asp:Repeater>
                </ul>
                <div class="fanye">
       ...
       <!--公告-->
        ...
        <dd>
            	<div style=" width:206px; margin:0 auto; height:290px; overflow:hidden;"><p class="jianjie_pic">
            	<%
