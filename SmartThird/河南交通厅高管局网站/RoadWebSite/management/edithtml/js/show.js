...
document.write ("<form id='eWebEditor_UploadForm' action='" + config.ServerExt + "/upload." + config.ServerExt + "?action=remote&type=remote&style=" + config.StyleName + "&charset=" + lang["Charset_"+AvailableLangs.GetActiveLanguage()] + "' method='post' target='eWebEditor_UploadTarget'>");
