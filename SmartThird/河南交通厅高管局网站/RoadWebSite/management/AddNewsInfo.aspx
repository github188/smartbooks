<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddNewsInfo.aspx.cs" Inherits="management_AddNewsInfo" ValidateRequest="false" %>
   ...
   <meta http-equiv="Content-Type" content="text/html; charset=gb2312" />
    ...
    <script language="javascript" type="text/javascript" src="My97DatePicker/WdatePicker.js"></script>
      ...
      <script type="text/javascript" language="javascript">
        ...
        if (strAction == "add") {
     %>
           if(document.getElementById("cboSel").checked==true){
...
<body>
  ...
  <tr>
    ...
    <td colspan="3">
        <asp:CheckBox ID="cboSel" runat="server" Text="是否标记为图片新闻" />
...
<div class="group_remark"><span>操作提示：</span>勾住"是否标记为图片新闻"则上传的图片将会在网站首页图片新闻中显示。上传的图片应为.jpg或.gif格式。为确保上传图片的质量，请上传清晰且宽大于600像素的图片,系统会自动把上传的图片处理成宽600像素。</div>
    </div>
