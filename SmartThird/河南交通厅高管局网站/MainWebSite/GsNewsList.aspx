<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GsNewsList.aspx.cs" Inherits="GsNewsList" %>
...
<body>
  ...
  <div class="right wid580">
        ...
        <ul class="alllist">
            <asp:Repeater ID="rptGsNewsList" runat="server">
              <ItemTemplate>
                <li><span>[<%# PubClass.Tool.Get_ShortDate(Eval("N_Time").ToString())%>]</span><a href='PageInfoDetail.aspx?nid=<%#  Eval("N_ID") %>' target="_blank" title='<%# Eval("N_Title") %>'><%# PubClass.Tool.SubString("[" + Eval("N_From").ToString() + "]" + Eval("N_Title").ToString(), 37)%> </a></li>
              </ItemTemplate>
            </asp:Repeater>  
        </ul>
        <div class="fanye">
