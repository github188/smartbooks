<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SelectServiceByCity.aspx.cs" Inherits="service_SelectServiceByCity" %>
...
<head id="Head1" runat="server">
    ...
    <title>按地市查询服务区-服务区管理-河南省交通运输厅高速公路管理局门户网站</title>
...
<body>
 ...
 <div style=" width:800px; margin:0 auto;"><iframe src="../CommonTop.aspx" scrolling="no" frameborder="0" style=" margin:0 auto; width:800px; height:253px; overflow:hidden;"></iframe></div>
  ...
  <div class="right wid580">
    <div class="weizhi">您的位置：<a href="../index.aspx">首页</a> >> <a href="Service_Index.aspx">服务区管理</a> >> 按地市查询</div>
    	<div class="pages">
        	
        	     <%
                     DataTable dtCity = DBHelper.GetDataSet("select * from S_CityInfo");
                     if (dtCity != null) {
                         for (int i = 0; i < dtCity.Rows.Count; i++)
                         {
                             int CI_ID = Convert.ToInt32(dtCity.Rows[i]["CI_ID"]);
                             string CI_Name = dtCity.Rows[i]["CI_Name"].ToString();
                             DataTable dtService = DBHelper.GetDataSet("select * from T_ServiceInfo where S_City='"+CI_Name+"' order by S_QuarterRank asc,S_Star desc");
                              %>
