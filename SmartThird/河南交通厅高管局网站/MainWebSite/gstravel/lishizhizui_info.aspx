...
<head runat="server">
    ...
    <title><%=((DataTable)ViewState["dtNews"]).Rows[0]["N_Title"] %>-河南之最-高速出游-河南省交通运输厅高速公路管理局门户网站</title>
...
<div id="main2">
	<div class="wid800tit mar_b10">您的位置：<a href="../index.aspx">首页</a> >> <a href="chuyou.html">高速出游</a> >> <a href="lishizhizui_list.aspx">河南之最</a></div>  
