<%@ Page Language="C#" AutoEventWireup="true" CodeFile="wenhuayichan_info.aspx.cs" Inherits="gstravel_wenhuayichan_info" %>
...
<head id="Head1" runat="server">
    ...
    <title><%=((DataTable)ViewState["dtNews"]).Rows[0]["N_Title"] %>-文化遗产-历史概况-高速出游-河南省交通运输厅高速公路管理局门户网站</title>
...
<div id="main2">
	<div class="wid800tit mar_b10">您的位置：<a href="../index.aspx">首页</a> >> <a href="chuyou.html">高速出游</a> >> <a href="lishigaikuang_list.html">历史概况</a> >> <a href="wenhuayichan_list.aspx">文化遗产</a></div>  
