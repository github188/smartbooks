...
public partial class AdminMgr_ImageTextNewsMgr : System.Web.UI.Page
{
    ...
    {
        Response.Redirect("AddImageTextNewsMgr.aspx?action=add&tid=" + Convert.ToInt32(((DataTable)ViewState["dtType"]).Rows[0]["T_ID"]));
    }
