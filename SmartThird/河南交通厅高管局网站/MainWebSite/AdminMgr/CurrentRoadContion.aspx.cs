...
public partial class AdminMgr_CurrentRoadContion : System.Web.UI.Page
{
    ...
    {
        Response.Redirect("AddCurrentRoadContion.aspx?action=add&tid=" + Convert.ToInt32(((DataTable)ViewState["dtType"]).Rows[0]["T_ID"]));
    }
    protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        else if (e.CommandName == "canRecord") {
            int nid = Convert.ToInt32(e.CommandArgument);
            NewsInfoService.Update_NewsInfoTidById(nid,81);
            binddata(Convert.ToInt32(((DataTable)ViewState["dtType"]).Rows[0]["T_ID"]));
        }
    }
