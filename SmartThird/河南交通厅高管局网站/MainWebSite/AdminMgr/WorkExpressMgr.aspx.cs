...
public partial class AdminMgr_WorkExpressMgr : System.Web.UI.Page
{
    ...
    {
        Response.Redirect("AddWorkExpress.aspx?action=add&tid=" + Convert.ToInt32(((DataTable)ViewState["dtType"]).Rows[0]["T_ID"]));
    }
