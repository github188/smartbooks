<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddKnowledgeArticle.aspx.cs" Inherits="AdminMgr_AddKnowledgeArticle" ValidateRequest="false" %>
<%@ Import Namespace="System.Data" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>编辑 <%=((DataTable)ViewState["dtModule"]).Rows[0]["KM_Name"]%>-河南省交通运输厅高速公路管理局</title>
...
<body>
    ...
    <div id="editmenu1">高速知识 >> 编辑<%=((DataTable)ViewState["dtModule"]).Rows[0]["KM_Name"]%></div>
  ...
  <tr>
    <td align="right" style="height: 30px;">
        发布日期：</td>
    <td >
      <asp:TextBox ID="txtTime" runat="server" Width="250px"  CssClass="Wdate" onFocus="WdatePicker({isShowClear:false,readOnly:true})"></asp:TextBox>
      </td>
  </tr>
  <tr>
