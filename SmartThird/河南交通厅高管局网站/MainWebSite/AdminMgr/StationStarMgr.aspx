<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StationStarMgr.aspx.cs" Inherits="AdminMgr_StationStarMgr" %>
            ...
            <Columns>
                ...
                <asp:TemplateField>
                    ...
                    <ItemTemplate>
                        ...
                        <a href='AddStationStar.aspx?tid=<%#DataBinder.Eval(Container.DataItem,"T_ID") %>&nid=<%#DataBinder.Eval(Container.DataItem,"N_ID") %>&action=update'>编辑</a>&nbsp;
