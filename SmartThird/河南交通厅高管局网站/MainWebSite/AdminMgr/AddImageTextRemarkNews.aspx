<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddImageTextRemarkNews.aspx.cs" Inherits="AdminMgr_AddImageTextRemarkNews" ValidateRequest="false" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
         function ValidateForm(){
            ...
            if(document.getElementById("txtRemarkContent").value==""){
               alert("请输入文章简介！");
               return false;
            }
            return true;
...
<body>
  ...
  <tr>
    <td   align="right" style="width:120px; height:30px;">
        文章标题：</td>
    <td colspan="3" >
        <asp:TextBox ID="txtTitle" runat="server" Width="660px" CssClass="inputBorderstyle1"></asp:TextBox></td>
  </tr>
  <tr>
    ...
    <td  align="right"  style="width:100px;">发布日期：</td>
  ...
  <tr>
    <td   align="right" style="height:30px;">
        文章简介：</td>
    <td colspan="3" >
        <asp:TextBox ID="txtRemarkContent" runat="server" Width="678px" CssClass="inputBorderstyle1" Height="80px" TextMode="MultiLine"></asp:TextBox></td>
  </tr>
  <tr>
