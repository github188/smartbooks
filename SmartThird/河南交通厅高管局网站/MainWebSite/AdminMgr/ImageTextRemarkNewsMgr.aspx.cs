...
public partial class AdminMgr_ImageTextRemarkNewsMgr : System.Web.UI.Page
{
    ...
    {
        Response.Redirect("AddImageTextRemarkNews.aspx?action=add&tid=" + Convert.ToInt32(((DataTable)ViewState["dtType"]).Rows[0]["T_ID"]));
    }
