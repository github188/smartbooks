<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CommonNewsMgr.aspx.cs" Inherits="AdminMgr_CommonNewsMgr" %>
            ...
            <Columns>
                ...
                <asp:TemplateField>
                    ...
                    <ItemTemplate>
                        ...
                        <a href='AddCommonNewsInfo.aspx?tid=<%#DataBinder.Eval(Container.DataItem,"T_ID") %>&nid=<%#DataBinder.Eval(Container.DataItem,"N_ID") %>&action=update'>编辑</a>&nbsp;
