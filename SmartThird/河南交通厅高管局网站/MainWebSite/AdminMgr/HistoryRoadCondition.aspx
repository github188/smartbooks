<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HistoryRoadCondition.aspx.cs" Inherits="AdminMgr_HistoryRoadCondition" %>
...
<body>
    ...
    <div id="editmenu1"><%=((DataTable)ViewState["dtType"]).Rows[0]["T_Remark"]%> >> <%=((DataTable)ViewState["dtType"]).Rows[0]["T_Name"]%></div>
