<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NewsInfoDetail.aspx.cs" Inherits="NewsInfoDetail" %>
...
<body>
  ...
  <div class="right wid580">
    <div class="weizhi">您的位置：<a href="index.aspx">首页</a> >>
     <a href='DepartBasicInfo.aspx?tid=60'><%=((DataTable)ViewState["dtNews"]).Rows[0]["T_Remark"] %></a> >>
      <a href='NewsInfoList.aspx'><%=((DataTable)ViewState["dtNews"]).Rows[0]["T_Name"] %></a></div>
    	<div class="pages">
