   ...
   public class CommonFunction
    {
       ...
       {
           if (HttpContext.Current.Session["GsglInfo"] != null)
           {
               if (HttpContext.Current.Session["GsglInfo"].ToString().Length == 0)
               {
       ...
       /// <summary>
       /// 下载数据时，首先需要知道文件在服务器是否存在或链接是否有效，利用HTTP的HEAD方法，根据HTTP的响应状态码，即可确定该资源的可用性
       /// </summary>
