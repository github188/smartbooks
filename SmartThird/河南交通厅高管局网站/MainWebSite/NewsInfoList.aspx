<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NewsInfoList.aspx.cs" Inherits="NewsInfoList" %>
...
<body>
	...
	<div class="right wid580">
        ...
        <ul class="alllist">
        	<asp:Repeater ID="rptNewsList" runat="server">
              <ItemTemplate>
                <li><span>[<%# PubClass.Tool.Get_ShortDate(Eval("N_Time").ToString())%>]</span><a href='NewsInfoDetail.aspx?nid=<%#  Eval("N_ID") %>' target="_blank" title='<%# Eval("N_Title") %>'><%# PubClass.Tool.SubString(Eval("N_Title").ToString(),37)%> </a></li>
              </ItemTemplate>
            </asp:Repeater>  
        </ul>
        <div class="fanye">
    ...
    <div class="wid210">
    	<div class="search2"><p style=" margin:5px 0 0 30px; color:#FFF; font-weight:bold;">站内搜索&nbsp;<input name="search" size="18" type="text" style="border:1px #06c solid;"/></p><p style="margin-left:60px;margin-top:10px;"><input name="search" value=" 搜索 "type="button" style="background:url(images/search_btn2.jpg) no-repeat; width:59px; height:22px; overflow:hidden;" />&nbsp;&nbsp;<input name="search" value="高级搜索"type="button" style="background:url(images/search_btn2.jpg) no-repeat; width:59px; height:22px; overflow:hidden;" /></p></div>
        
        <div class="zhengwu mar_t10">
        	<dl>
            	<dt></dt>
                <dd>
                	<ul class="lanmulist">
                    	<li><a href="DepartBasicInfo.aspx?tid=60">机构简介</a></li>
                        <li><a href="DepartBasicInfo.aspx?tid=61">机构职能</a></li>
                        <li><a href="NewsInfoList.aspx?tid=62">政务信息</a></li>
                        <li><a href="NewsInfoList.aspx?tid=63">公示公告</a></li>
                        <li><a href="EventList.aspx">大事记</a></li>
                    </ul>
                </dd>
                <dd class="lanmu_b"></dd>
            </dl>
