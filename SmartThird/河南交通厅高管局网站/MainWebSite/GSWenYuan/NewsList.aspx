<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NewsList.aspx.cs" Inherits="service_NewsList" %>
...
<body>
  ...
  <div class="right wid580">
    	<div class="weizhi">您的位置：<a href="../index.aspx">首页</a> >> 高速文苑 >> <%=((DataTable)ViewState["dtType"]).Rows[0]["T_Name"]%></div>
        <ul class="alllist">
  ...
  <div class="wid210">
    ...
    <div style="margin-top:5px;"><a href="../guojian/list.html"><img src="../guojian/guojianico.jpg" width="210px" height="70px" alt="典型经验交流" /></a></div>
